            ...
            <?php foreach ($this->model->Listar() as $r) : ?>
                <tr>
                    ...
                    <td class="center">
                        ...
                        <a class="btn-danger m4" onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?c=usuario&a=Eliminar&id=<?php echo $r->id; ?>"><i class="far fa-trash-alt"></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
